const BASE_URL =`${BASE_URL_All}:8996/Agra`;
const GEOSERVER_BASE_URL = "http://localhost:8080/geoserver/AGR_Summary";
...
function showTables() {
    ...
    hideElements(['legendBtn', 'live_legend', 'type_legend', 'Condition_legend', 'CUS_legend', 'RoadCategory_legend', 'Material_legend', 'Ownership_legend',
        ...
        'tableContainer_summaryfiltermat', 'tableContainer_summaryfilter', 'tableContainer_summaryfilterOwn','table_data',
...
function showTables2() {
    ...
    hideElements(['dataTable', 'tableContainer_summary', 'tableContainer_summaryfilter', 'tableContainer', //'Scoring_dataTable', 'Scoreing_tableContainer','tableContainer_Drain', 'dataTable_Drain',
        ...
        'Material_legend', 'Ownership_legend', 'tableContainer_summaryfiltermat', 'tableContainer_summaryfilterOwn','table_data',//'Priority_legend', 'Drain_Type_Legend',
    ]);
}
...
var zone_boundary = new ol.layer.Image({
    title: "Agra Zone Boundary",
    //  extent: [-180, -90, -180, 90],
    source: new ol.source.ImageWMS({
        url: `${GEOSERVER_BASE_URL}/wms?`,
        params: {
            LAYERS: "AGR_Summary:agra_zone_boundary",
        },
        ratio: 1,
...
var ward_boundary = new ol.layer.Image({
    title: "Agra Ward Boundary",
    //  extent: [-180, -90, -180, 90],
    source: new ol.source.ImageWMS({
        url: `${GEOSERVER_BASE_URL}/wms?`,
        params: {
            LAYERS: "AGR_Summary:agra_ward_boundary",
        },
        ratio: 1,
        serverType: "geoserver",
    }),
...
function clearAllVectorLayers() {
    ...
    map.getLayers().getArray().slice().forEach(layer => {
        if ((layer instanceof ol.layer.Tile || layer instanceof ol.layer.Image) &&
            ...
            if (layer.get('title') !== 'Agra Zone Boundary' && layer.get('title') !== 'Agra Ward Boundary') {
...
function zoomToIndia() {
    ...
    view.setCenter([78.0000 , 27.1333]);
    view.setZoom(12.2);
    view.setRotation(0);
...
const locationTypes = [
    ...
    { type: 'electric_substation', icon: '../assets/icons/power-plant.png', id: 'showelectric' },
    { type: 'community_toilet', icon: '../assets/icons/toilet-.png', id: 'showcommunity' }
...
$(document).ready(function () {
    $.ajax({
        ...
        success: function (xml) {
            var select = $("#layer");
            const targetLayer = "AGR_Summary:agra_road_net4326"; // your desired layer
            $(xml)
                .find("FeatureType")
                .each(function () {
...
function updateSummary(data) {
    ...
    const summaryData = {
        'No. of Zones': { value: safeValue('zone_count'), id: 'Agra_Zone_no()' },
        'Total Road Length': { value: `${safeValue('total_length_km').toFixed(2) } km`, id: "Agra_road_net4326_Length_Count(); updateNavBarWithFunctionName('Total Road Length');" },
        'Total No. of Roads': { value: safeValue('total_length_count'), onclick: "Agra_road_net4326_Length_Count(); updateNavBarWithFunctionName('Total Road Count');" },
        'Total Ward No.': { value: safeValue('ayo_ward'), id: 'Agra_Ward_NO()' },
        'Road Count by Condition': {
            value: `
                Good - <a href="javascript:void(0)" onclick="Agra_Condition_cat('condition','Good'); updateNavBarWithFunctionName('Road Condition Good');" style="color:green;">${safeValue('condition_count_green')}</a><br>
                Poor - <a href="javascript:void(0)" onclick="Agra_Condition_cat('condition','Poor'); updateNavBarWithFunctionName('Road Condition Poor');" style="color:red;">${safeValue('condition_count_red')}</a><br>
                Moderate - <a href="javascript:void(0)" onclick="Agra_Condition_cat('condition','Moderate'); updateNavBarWithFunctionName('Road Condition Moderate');" style="color:yellow;">${safeValue('condition_count_yellow')}</a><br>
                NA - <a href="javascript:void(0)" onclick="Agra_Condition_cat('condition','NA'); updateNavBarWithFunctionName('Road Condition NA');" style="color:pink;">${safeValue('condition_count_na')}</a><br>
            `
        },

        'Road Count by Material': {
            value: `
                Bitumen - <a href="javascript:void(0)" onclick="Agra_Material_cat('material','Bitumen'); updateNavBarWithFunctionName('Road Material Bitumen');" style="color:darkred;">${safeValue('count_bitumen')}</a><br>
                CC - <a href="javascript:void(0)" onclick="Agra_Material_cat('material','CC'); updateNavBarWithFunctionName('Road Material CC');" style="color:#1ad7b0;">${safeValue('count_cc')}</a><br>
                Interlocking - <a href="javascript:void(0)" onclick="Agra_Material_cat('material','Interlocking'); updateNavBarWithFunctionName('Road Material Interlocking');" style="color:#2392ed;">${safeValue('count_interlocking')}</a><br>
                Kachcha - <a href="javascript:void(0)" onclick="Agra_Material_cat('material','Kachcha'); updateNavBarWithFunctionName('Road Material Kachcha');" style="color:#6036d0;">${safeValue('count_kachcha')}</a><br>
                NA - <a href="javascript:void(0)" onclick="Agra_Material_cat('material','NA'); updateNavBarWithFunctionName('Road Material NA');" style="color:#dfc223;">${safeValue('count_na')}</a>
                `,
            onclick: 'Agra_Material()'
        },
        'Road Count by Ownership': {
            value: `
                AGRNN - <a href="javascript:void(0)" onclick="Agra_Ownership_cat('ownership','Agra Nagar Nigam'); updateNavBarWithFunctionName('Road Ownership of Agra Nagar Nigam');" style="color:#5aeee5;">${safeValue('count_agrnn')}</a><br>
                PWD - <a href="javascript:void(0)" onclick="Agra_Ownership_cat('ownership','PWD'); updateNavBarWithFunctionName('Road Ownership of PWD');" style="color:#69e70f;">${safeValue('count_pwd')}</a><br>
                Private Road - <a href="javascript:void(0)" onclick="Agra_Ownership_cat('ownership','Private Road'); updateNavBarWithFunctionName('Road Ownership of Private Road');" style="color:#ed2323;">${safeValue('count_pvt')}</a><br>
                Railway - <a href="javascript:void(0)" onclick="Agra_Ownership_cat('ownership','Railway'); updateNavBarWithFunctionName('Road Ownership of Railway');" style="color:#f16a16;">${safeValue('count_railway')}</a><br>
                Development Authority - <a href="javascript:void(0)" onclick="Agra_Ownership_cat('ownership','Development Authority'); updateNavBarWithFunctionName('Road Ownership of Development Authority');" style="color:#ecc82e;">${safeValue('count_da')}</a><br>
                Government Department - <a href="javascript:void(0)" onclick="Agra_Ownership_cat('ownership','Government Department'); updateNavBarWithFunctionName('Road Ownership Government Department');" style="color:#8d139b;">${safeValue('count_gd')}</a><br>    
                Defence - <a href="javascript:void(0)" onclick="Agra_Ownership_cat('ownership','Defence'); updateNavBarWithFunctionName('Road Ownership Defence');" style="color:#8d139b;">${safeValue('count_defence')}</a><br>    
                NHAI - <a href="javascript:void(0)" onclick="Agra_Ownership_cat('ownership','NHAI'); updateNavBarWithFunctionName('Road Ownership NHAI');" style="color:#8d139b;">${safeValue('count_nhai')}</a><br>    

               
                `,
            onclick: 'Agra_Ownership()'
        },
        'Road Count by CUS': {
            value: `
                15th Finance - <a href="javascript:void(0)" onclick="Agra_CUS_cat('cus','15th Finance'); updateNavBarWithFunctionName('Road CUS 15th Finance');" style="color:#e63dee;">${safeValue('count_cus_15th')}</a><br>
                Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="Agra_CUS_cat('cus','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('Road CUS Nagar Nigam Nidhi');" style="color:cyan;">${safeValue('count_cus_nnn')}</a><br>
                DUDA - <a href="javascript:void(0)" onclick="Agra_CUS_cat('cus','Duda'); updateNavBarWithFunctionName('Road CUS DUDA');" style="color:#e1ca4c;">${safeValue('count_cus_duda')}</a><br>
                14th Finance - <a href="javascript:void(0)" onclick="Agra_CUS_cat('cus','14th Finance'); updateNavBarWithFunctionName('Road CUS 14th Finance');" style="color:#e63dee;">${safeValue('count_cus_14th')}</a><br>
                NA - <a href="javascript:void(0)" onclick="Agra_CUS_cat('cus','NA'); updateNavBarWithFunctionName('Road CUS NA');" style="color:cyan;">${safeValue('count_na')}</a><br>
                Others - <a href="javascript:void(0)" onclick="Agra_CUS_cat('cus_class','Others'); updateNavBarWithFunctionName('Road CUS Others');" style="color:cyan;">${safeValue('count_cus_others')}</a><br>
                PWD - <a href="javascript:void(0)" onclick="Agra_CUS_cat('cus','PWD'); updateNavBarWithFunctionName('Road CUS PWD');" style="color:cyan;">${safeValue('count_cus_pwd')}</a><br>
        ...
        'Road Count by Category': {
            value: `
                Local Street - <a href="javascript:void(0)" onclick="Agra_TypeSub_cat('category','Local Street'); updateNavBarWithFunctionName('Road Category Local Street');" style="color: #14cee3;">${safeValue('count_local_street')}</a><br>
                Collector - <a href="javascript:void(0)" onclick="Agra_TypeSub_cat('category','Collector'); updateNavBarWithFunctionName('Road Category Collector');" style="color: #e63dee;">${safeValue('count_collector')}</a><br>
                Arterial - <a href="javascript:void(0)" onclick="Agra_TypeSub_cat('category','Arterial'); updateNavBarWithFunctionName('Road Category Arterial');" style="color: #e1ca4c;">${safeValue('count_arterial')}</a><br>
                Sub Arterial - <a href="javascript:void(0)" onclick="Agra_TypeSub_cat('category','Subarterial'); updateNavBarWithFunctionName('Road Category Sub Arterial');" style="color: #83e45c;">${safeValue('count_subarterial')}</a><br>
    ...
    const zoneCards = [
        {
            ...
            value: `<a href="javascript:void(0)" onclick="Agra_Zone_no('zone_no','${zoneNo}'); updateNavBarWithFunctionName('Zone-${zoneNo} Total Road Length');" style="color:black;">${data.length_km.toFixed(2)} km</a>`
        },
        {
            title: 'Total No. of Roads',
            value: `<a href="javascript:void(0)" onclick="Agra_Zone_no('zone_no','${zoneNo}'); updateNavBarWithFunctionName('Zone-${zoneNo} Total Road Count');" style="color:black;">${data.total_no_of_roads}</a>`
        },
        {
            title: 'Road Condition',
            value: `
                    Good <a href="javascript:void(0)" onclick="Agra_Zone_Condition('${zoneNo}','condition','Good'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition Good');" style="color:green;">- ${data.condition_count_green}</a> <br> 
                    Moderate <a href="javascript:void(0)" onclick="Agra_Zone_Condition('${zoneNo}','condition','Moderate'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition Moderate');" style="color:yellow;">- ${data.condition_count_yellow}</a> <br> 
                    Poor <a href="javascript:void(0)" onclick="Agra_Zone_Condition('${zoneNo}','condition','Poor'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition Poor');" style="color:red;">- ${data.condition_count_red}</a><br>
                    NA <a href="javascript:void(0)" onclick="Agra_Zone_Condition('${zoneNo}','condition','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition NA');" style="color:pink;">- ${data.condition_count_na}</a> <br> 
                    `
        },
        {
            title: 'Materials',
            value: `
                    Bitumen <a href="javascript:void(0)" onclick="Agra_Zone_Material('${zoneNo}','material','Bitumen'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material Bitumen');" style="color:darkred;">- ${data.count_bitumen}</a> <br>
                    CC <a href="javascript:void(0)" onclick="Agra_Zone_Material('${zoneNo}','material','CC'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material CC');" style="color:#1ad7b0;">- ${data.count_cc}</a> <br>
                    Interlocking <a href="javascript:void(0)" onclick="Agra_Zone_Material('${zoneNo}','material','Interlocking'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material Interlocking');" style="color:#2392ed;">- ${data.count_interlocking}</a> <br>
                    Kachcha <a href="javascript:void(0)" onclick="Agra_Zone_Material('${zoneNo}','material','Kachcha'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material Kachcha');" style="color:#6036d0;">- ${data.count_kachcha}</a><br>
                    NA - <a href="javascript:void(0)" onclick="Agra_Zone_Material('${zoneNo}','material','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material NA');" style="color:#dfc223;">${data.count_na}</a>
                    `
        },
        {
            title: 'Ownership',
            value: `
               AGRNN - <a href="javascript:void(0)" onclick="Agra_Zone_Ownership('${zoneNo}','ownership','Agra Nagar Nigam'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership of Agra Nagar Nigam');" style="color:#5aeee5;">${data.count_agrnn}</a><br>
                PWD - <a href="javascript:void(0)" onclick="Agra_Zone_Ownership('${zoneNo}','ownership','PWD'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership of PWD');" style="color:#69e70f;">${data.count_pwd}</a><br>
                Private Road - <a href="javascript:void(0)" onclick="Agra_Zone_Ownership('${zoneNo}','ownership','Private Road'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership of Private Road');" style="color:#ed2323;">${data.count_pvt}</a><br>
                Railway - <a href="javascript:void(0)" onclick="Agra_Zone_Ownership('${zoneNo}','ownership','Railway'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership of Railway');" style="color:#f16a16;">${data.count_railway}</a><br>
                Development Authority - <a href="javascript:void(0)" onclick="Agra_Zone_Ownership('${zoneNo}','ownership','Development Authority'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership of Development Authority');" style="color:#ecc82e;">${data.count_da}</a><br>
                Government Department - <a href="javascript:void(0)" onclick="Agra_Zone_Ownership('${zoneNo}','ownership','Government Department'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Government Department');" style="color:#8d139b;">${data.count_gd}</a><br>    
                Defence - <a href="javascript:void(0)" onclick="Agra_Zone_Ownership('${zoneNo}','ownership','Defence'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Defence');" style="color:#8d139b;">${data.count_defence}</a><br>    
                NHAI - <a href="javascript:void(0)" onclick="Agra_Zone_Ownership('${zoneNo}','ownership','NHAI'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership NHAI');" style="color:#8d139b;">${data.count_nhai}</a><br>    
   `
        },
        {
            title: 'CUS',
            value: ` 
               15th Finance - <a href="javascript:void(0)" onclick="Agra_Zone_CUS('${zoneNo}','cus','15th Finance'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS 15th Finance');" style="color:#e63dee;">${data.count_cus_15th}</a><br>
                Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="Agra_Zone_CUS('${zoneNo}','cus','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Nagar Nigam Nidhi');" style="color:cyan;">${data.count_cus_nnn}</a><br>
                DUDA - <a href="javascript:void(0)" onclick="Agra_Zone_CUS('${zoneNo}','cus','Duda'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS DUDA');" style="color:#e1ca4c;">${data.count_cus_duda}</a><br>
                14th Finance - <a href="javascript:void(0)" onclick="Agra_Zone_CUS('${zoneNo}','cus','14th Finance'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS 14th Finance');" style="color:#e63dee;">${data.count_cus_14th}</a><br>
                NA - <a href="javascript:void(0)" onclick="Agra_Zone_CUS('${zoneNo}','cus','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS NA');" style="color:cyan;">${data.count_na}</a><br>
               Others - <a href="javascript:void(0)" onclick="Agra_Zone_CUS('${zoneNo}','cus_class','Others'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Others');" style="color:cyan;">${data.count_cus_others}</a><br>
                PWD - <a href="javascript:void(0)" onclick="Agra_Zone_CUS('${zoneNo}','cus','PWD'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS PWD');" style="color:#ec1248;">${data.count_cus_pwd}</a><br>
        ...
        },
        {
            title: 'Category',
            value: `
                    Local Street - <a href="javascript:void(0)" onclick="Agra_Zone_TypeSub('${zoneNo}','category','Local Street'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category Local Street');" style="color: #14cee3;">${data.count_local_street} </a><br>
                    Collector - <a href="javascript:void(0)" onclick="Agra_Zone_TypeSub('${zoneNo}','category','Collector'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category Collector');" style="color: #e63dee;">${data.count_collector}</a><br>
                    Arterial - <a href="javascript:void(0)" onclick="Agra_Zone_TypeSub('${zoneNo}','category','Arterial'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category Arterial');" style="color: #e1ca4c;">${data.count_arterial}</a><br>
                    Sub Arterial - <a href="javascript:void(0)" onclick="Agra_Zone_TypeSub('${zoneNo}','category','Sub Arterial'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category Sub Arterial');" style="color: #83e45c;">${data.count_subarterial}</a><br>
                    `
        },
    ];
        ...
        .then(responseData => {
            if (responseData.status) {
                ...
                const details = [
                    ...
                    {
                        title: 'Total Road Length',
                        value: `<a href="javascript:void(0)" onclick="Agra_Ward_no('ward_no', '${wardNo}'); updateNavBarWithFunctionName('Ward-${wardNo} Total Road Length');" style="color:black;">${responseData.length_km} km</a>`
                    },
                    {
                        title: 'Total No. of Roads',
                        value: `<a href="javascript:void(0)" onclick="Agra_Ward_no('ward_no', '${wardNo}'); updateNavBarWithFunctionName('Ward-${wardNo} Total Road Count');" style="color:black;">${responseData.total_no_of_roads}</a>`
                    },
                    {
                        title: 'Road Condition',
                        value: `
                                Good - <a href="javascript:void(0)" onclick="Agra_Ward_Condition('${wardNo}', 'condition', 'Good'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition Good');" style="color:green;">${responseData.condition_count_green}</a><br> 
                                Moderate - <a href="javascript:void(0)" onclick="Agra_Ward_Condition('${wardNo}', 'condition', 'Moderate'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition Moderate');" style="color:yellow;">${responseData.condition_count_yellow}</a><br> 
                                Poor - <a href="javascript:void(0)" onclick="Agra_Ward_Condition('${wardNo}', 'condition', 'Poor'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition Poor');" style="color:red;">${responseData.condition_count_red}</a><br>
                                NA - <a href="javascript:void(0)" onclick="Agra_Ward_Condition('${wardNo}', 'condition', 'NA'); updateNavBarWithFunctionName('Ward-${wardNo} Road Condition NA');" style="color:pink;">${responseData.condition_count_na}</a>
                                `
                    },
                    {
                        title: 'Materials',
                        value: `
                                Bitumen - <a href="javascript:void(0)" onclick="Agra_Ward_Material('${wardNo}', 'material', 'Bitumen'); updateNavBarWithFunctionName('Ward-${wardNo} Road Material Bitumen');" style="color:darkred;">${responseData.count_bitumen}</a><br> 
                                CC - <a href="javascript:void(0)" onclick="Agra_Ward_Material('${wardNo}', 'material', 'CC'); updateNavBarWithFunctionName('Ward-${wardNo} Road Material CC');" style="color:cyan;">${responseData.count_cc}</a><br> 
                                Interlocking - <a href="javascript:void(0)" onclick="Agra_Ward_Material('${wardNo}', 'material', 'Interlocking'); updateNavBarWithFunctionName('Ward-${wardNo} Road Material Interlocking');" style="color:blue;">${responseData.count_interlocking}</a><br>
                                Kachcha - <a href="javascript:void(0)" onclick="Agra_Ward_Material('${wardNo}', 'material', 'Kachcha'); updateNavBarWithFunctionName('Ward-${wardNo} Road Material Kachcha');" style="color:purple;">${responseData.count_kachcha}</a><br>
                                NA - <a href="javascript:void(0)" onclick="Agra_Ward_Material('${wardNo}','material','NA'); updateNavBarWithFunctionName('Ward-${wardNo} Road Material NA');" style="color:#dfc223;">${responseData.count_na}</a>
                                `
                    },
                    {
                        title: 'Ownership',
                        value: `
              AGRNN - <a href="javascript:void(0)" onclick="Agra_Ward_Ownership('${wardNo}','ownership','Agra Nagar Nigam'); updateNavBarWithFunctionName('Zone-${wardNo} Road Ownership of Agra Nagar Nigam');" style="color:#5aeee5;">${responseData.count_agrnn}</a><br>
                PWD - <a href="javascript:void(0)" onclick="Agra_Ward_Ownership('${wardNo}','ownership','PWD'); updateNavBarWithFunctionName('Zone-${wardNo} Road Ownership of PWD');" style="color:#69e70f;">${responseData.count_pwd}</a><br>
                Private Road - <a href="javascript:void(0)" onclick="Agra_Ward_Ownership('${wardNo}','ownership','Private Road'); updateNavBarWithFunctionName('Zone-${wardNo} Road Ownership of Private Road');" style="color:#ed2323;">${responseData.count_pvt}</a><br>
                Railway - <a href="javascript:void(0)" onclick="Agra_Ward_Ownership('${wardNo}','ownership','Railway'); updateNavBarWithFunctionName('Zone-${wardNo} Road Ownership of Railway');" style="color:#f16a16;">${responseData.count_railway}</a><br>
                Development Authority - <a href="javascript:void(0)" onclick="Agra_Ward_Ownership('${wardNo}','ownership','Development Authority'); updateNavBarWithFunctionName('Zone-${wardNo} Road Ownership of Development Authority');" style="color:#ecc82e;">${responseData.count_da}</a><br>
                Government Department - <a href="javascript:void(0)" onclick="Agra_Ward_Ownership('${wardNo}','ownership','Government Department'); updateNavBarWithFunctionName('Zone-${wardNo} Road Ownership Government Department');" style="color:#8d139b;">${responseData.count_gd}</a><br>    
                Defence - <a href="javascript:void(0)" onclick="Agra_Ward_Ownership('${wardNo}','ownership','Defence'); updateNavBarWithFunctionName('Zone-${wardNo} Road Ownership Defence');" style="color:#8d139b;">${responseData.count_defence}</a><br>    
                NHAI - <a href="javascript:void(0)" onclick="Agra_Ward_Ownership('${wardNo}','ownership','NHAI'); updateNavBarWithFunctionName('Zone-${wardNo} Road Ownership NHAI');" style="color:#8d139b;">${responseData.count_nhai}</a><br>    
  `
                    },
                    {
                        title: 'CUS',
                        value: `
                    15th Finance - <a href="javascript:void(0)" onclick="Agra_Ward_CUS('${wardNo}','cus','15th Finance'); updateNavBarWithFunctionName('Zone-${wardNo} Road CUS 15th Finance');" style="color:#e63dee;">${responseData.count_cus_15th}</a><br>
                Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="Agra_Ward_CUS('${wardNo}','cus','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('Zone-${wardNo} Road CUS Nagar Nigam Nidhi');" style="color:cyan;">${responseData.count_cus_nnn}</a><br>
                DUDA - <a href="javascript:void(0)" onclick="Agra_Ward_CUS('${wardNo}','cus','Duda'); updateNavBarWithFunctionName('Zone-${wardNo} Road CUS DUDA');" style="color:#e1ca4c;">${responseData.count_cus_duda}</a><br>
                14th Finance - <a href="javascript:void(0)" onclick="Agra_Ward_CUS('${wardNo}','cus','14th Finance'); updateNavBarWithFunctionName('Zone-${wardNo} Road CUS 14th Finance');" style="color:#e63dee;">${responseData.count_cus_14th}</a><br>
                NA - <a href="javascript:void(0)" onclick="Agra_Ward_CUS('${wardNo}','cus','NA'); updateNavBarWithFunctionName('Zone-${wardNo} Road CUS NA');" style="color:cyan;">${responseData.count_na}</a><br>
               PWD - <a href="javascript:void(0)" onclick="Agra_Ward_CUS('${wardNo}','cus','PWD'); updateNavBarWithFunctionName('Zone-${wardNo} Road CUS PWD');" style="color:cyan;">${responseData.count_cus_pwd}</a><br>
                Others - <a href="javascript:void(0)" onclick="Agra_Ward_CUS('${wardNo}','cus_class','Others'); updateNavBarWithFunctionName('Zone-${wardNo} Road CUS Others');" style="color:#ec1248;">${responseData.count_cus_others}</a><br>
                ...
                `  },
                    {
                        ...
                        value: `
                                Local Street - <a href="javascript:void(0)" onclick="Agra_Ward_TypeSub('${wardNo}','category','Local Street'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category Local Street');" style="color: #14cee3;">${responseData.count_local_street} </a><br>
                                Collector - <a href="javascript:void(0)" onclick="Agra_Ward_TypeSub('${wardNo}','category','Collector'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category Collector');" style="color: #e63dee;">${responseData.count_collector}</a><br>
                                Arterial - <a href="javascript:void(0)" onclick="Agra_Ward_TypeSub('${wardNo}','category','Arterial'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category Arterial');" style="color: #e1ca4c;">${responseData.count_arterial}</a><br>
                                Sub Arterial - <a href="javascript:void(0)" onclick="Agra_Ward_TypeSub('${wardNo}','category','Sub Arterial'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category Sub Arterial');" style="color: #83e45c;">${responseData.count_subarterial}</a><br>
                               `},
                ];
...
function highlightFeatureOnMap(gisId) {
    let wfsUrl = `${GEOSERVER_BASE_URL}/wfs?service=WFS&version=1.1.0&request=GetFeature
        &typename=	AGR_Summary:agra_road_net4326
...
function MVNN_Road_popup() {
    ...
    function buildPopupHTML(properties) {
        ...
        <div class="row-line"><strong>Length (Km) :</strong> ${properties.length_km || 'N/A'}</div>
        <div class="row-line"><strong>Road Name :</strong> ${properties.road_name || 'N/A'}</div>
        </div>
        `;
    }
}
function Agra_road_net4326_Length_Count() {
    removeCurrentLayer();
    clearVectorLayers();
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_net4326',
...
function Agra_Ownership(cqlFilter) {
    removeCurrentLayer(); clearVectorLayers();
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_own',
...
function Agra_Material(cqlFilter) {
    removeCurrentLayer(); clearVectorLayers();
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_material',
                'CQL_FILTER': cqlFilter,
            },
            ratio: 1,
            serverType: 'geoserver'
...
function Agra_Types(cqlFilter) {
    removeCurrentLayer(); clearVectorLayers();
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_category',
                'CQL_FILTER': cqlFilter,
            },
            ratio: 1,
            serverType: 'geoserver'
...
$(document).ready(function () {
   ...
   $('#roadNamesDropdown').select2({
    ...
    templateSelection: function (data) {
        ...
        return $(
            `<span class="road-select-label" title="${data.text}">
                ${data.text}
             </span>`
        );
    }
    ...
    // -----------------------------
    // 🔍 ICON CLICK → OPEN DROPDOWN
    // -----------------------------
    $('#searchActionIcon').on('click', function () {
        const $dropdown = $('#roadNamesDropdown');
        $dropdown.show();               // show hidden select
        $dropdown.select2('open');      // open list
    });

    // close hone par hide
    $('#roadNamesDropdown').on('select2:close', function () {
        $(this).hide();
    });
$('#roadNamesDropdown').on('change', function () {
    let selectedRoadId = $(this).val();
    if (selectedRoadId) {
        fetchRoadData(selectedRoadId);
    }
});
...
// LOAD ROAD NAMES + IDS
// -----------------------------
const url = `${GEOSERVER_BASE_URL}/wfs?service=WFS&version=1.0.0&request=GetFeature&typeName=AGR_Summary:agra_road_net4326&outputFormat=application/json`;
...
xhr.onreadystatechange = function () {
    if (xhr.readyState === 4 && xhr.status === 200) {
        ...
        response.features.forEach(f => {
            ...
            if (name && id) {
                roads[id] = name; // unique by road_id
            }
        });

        populateDropdown(roads);
    }
};

xhr.send();

function populateDropdown(roads) {
    let dropdown = $('#roadNamesDropdown');
    dropdown.empty();

    dropdown.append(new Option('', '', false, false));

    Object.entries(roads).forEach(([roadId, roadName]) => {
        const label = `${roadName} (ID: ${roadId})`;
        dropdown.append(new Option(label, roadId, false, false));
    });
...
function Agra_Zone_no(column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
...
function Agra_Ward_no(column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
...
function Agra_Condition_cat(column, value) {
    removeCurrentLayer();
    ///  clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': '	AGR_Summary:agra_road_condition',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Agra_Material_cat(column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_material',  // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Agra_Ownership_cat(column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_own',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Agra_CUS_cat(column, value) {
    removeCurrentLayer();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    console.log(`Applying CQL_FILTER: ${cqlFilter}`); // Debugging log
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_cus',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Agra_TypeSub_cat(column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_category',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Agra_Zone_Condition(zone_no, column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': '	AGR_Summary:agra_road_condition',
                'CQL_FILTER': cqlFilter,
                'TILED': true
            },
            ratio: 1,
...
function Agra_Zone_Material(zone_no, column, value) {
    removeCurrentLayer();
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_material',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Agra_Zone_Ownership(zone_no, column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus","cus_class"];
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_own',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Agra_Zone_CUS(zone_no, column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus","cus_class"];
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_cus',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Agra_Zone_TypeSub(zone_no, column, value) {
    removeCurrentLayer();
    clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus","cus_class"];
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'AGR_Summary:agra_road_category',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Agra_Ward_Condition(ward_no, column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': '	AGR_Summary:agra_road_condition', // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function Agra_Ward_Material(ward_no, column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus","cus_class"];
...
function Agra_Ward_Ownership(ward_no, column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
...
function Agra_Ward_CUS(ward_no, column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
...
function Agra_Ward_TypeSub(ward_no, column, value) {
    removeCurrentLayer();
    clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus","cus_class"];
...
function determineLayer() {
   if (selectedFilters.material) {
        ...
        document.getElementById('RoadCategory_legend').style.display = 'none';
        document.getElementById('Ownership_legend').style.display = 'none';
        return 'AGR_Summary:agra_road_mat';
    } 
        ...
        document.getElementById('Ownership_legend').style.display = 'none';
        document.getElementById('Material_legend').style.display = 'none';
        return 'AGR_Summary:agra_road_category';
    } 
        ...
        document.getElementById('RoadCategory_legend').style.display = 'none';
        document.getElementById('Material_legend').style.display = 'none';
        return 'AGR_Summary:agra_road_own';
    } 
        ...
        document.getElementById('Ownership_legend').style.display = 'none';
        document.getElementById('Material_legend').style.display = 'none';
        return 'AGR_Summary:agra_road_condition';
    }
    return 'AGR_Summary:agra_road_net4326';
}
                ...
                geojson.features.forEach(({ properties }) => {
                    tableBody.insertAdjacentHTML('beforeend', `
                        <tr>
                            ...
                            <td>${properties.length_km.toFixed(2)  || 'N/A'}</td>
...
function displayTablePage(page) {
    ...
    const rows = document.querySelectorAll("#dataTable_summary tbody tr");
...
function generatePaginationButtons() {
    const totalRows = document.querySelectorAll("#dataTable_summary tbody tr").length;
    const totalPages = Math.ceil(totalRows / rowsPerPage);

    let paginationContainer = document.getElementById("tableContainer_summary");
