const BASE_URL = `${BASE_URL_All}:8993/Firozabad`;
const GEOSERVER_BASE_URL = "http://localhost:8080/geoserver/FRZ_Summary";
...
var view = new ol.View({
    ...
    center: [77.66302929790011, 27.492865593],
    zoom: 12,
});
...
//     title: "firozabad Zone Boundary",
//     //  extent: [-180, -90, -180, 90],
//     source: new ol.source.ImageWMS({
//         url: `${GEOSERVER_BASE_URL}/wms?`,
//         params: {
//             LAYERS: "FRZ_Summary:firozabad_zone_boundary",
//         },
//         ratio: 1,
...
var ward_boundary = new ol.layer.Image({
    title: "firozabad Ward Boundary",
    //  extent: [-180, -90, -180, 90],
    source: new ol.source.ImageWMS({
        url: `${GEOSERVER_BASE_URL}/wms?`,
        params: {
            LAYERS: "FRZ_Summary:firozabad_ward_boundary",
        },
        ratio: 1,
        serverType: "geoserver",
    }),
...
function clearAllVectorLayers() {
    ...
    map.getLayers().getArray().slice().forEach(layer => {
        if ((layer instanceof ol.layer.Tile || layer instanceof ol.layer.Image) &&
            ...
            if (layer.get('title') !== 'firozabad Zone Boundary' && layer.get('title') !== 'firozabad Ward Boundary') {
...
function zoomToIndia() {
    ...
    view.setCenter([78.3940, 27.1596]);
    view.setZoom(12);
    view.setRotation(0);
...
function updateSummary(data) {
    ...
    const summaryData = {
        // 'No. of Zones': { value: safeValue('zone_count'), onclick: 'firozabad_Zone_no()' },
        'Total Road Length': { value: `${safeValue('total_length_km')} km`, onclick: "firozabad_Road_Length_Count(); updateNavBarWithFunctionName('Total Road Length');" },
        'Total No. of Roads': { value: safeValue('total_length_count'), onclick: "firozabad_Road_Length_Count(); updateNavBarWithFunctionName('Total Road Count');" },
        'Total Ward No.': { value: safeValue('ayo_ward'), onclick: 'firozabad_Ward_NO()' },
        'Road Count by Condition': {
            value: `
                Good - <a href="javascript:void(0)" onclick="firozabad_Condition_cat('condition','Good'); updateNavBarWithFunctionName('Road Condition Good');" style="color:green;">${safeValue('condition_count_green')}</a><br>
                Poor - <a href="javascript:void(0)" onclick="firozabad_Condition_cat('condition','Poor'); updateNavBarWithFunctionName('Road Condition Poor');" style="color:red;">${safeValue('condition_count_red')}</a><br>
                Moderate - <a href="javascript:void(0)" onclick="firozabad_Condition_cat('condition','Moderate'); updateNavBarWithFunctionName('Road Condition Moderate');" style="color:yellow;">${safeValue('condition_count_yellow')}</a><br>
              NA - <a href="javascript:void(0)" onclick="firozabad_Condition_cat('condition','NA'); updateNavBarWithFunctionName('Road Condition NA');" style="color:pink;">${safeValue('condition_count_na')}</a><br>
            `
        },
        'Road Count by Material': {
            value: `
                Bitumen - <a href="javascript:void(0)" onclick="firozabad_Material_cat('material','Bitumen'); updateNavBarWithFunctionName('Road Material Bitumen');" style="color:darkred;">${safeValue('count_bitumen')}</a><br>
                CC - <a href="javascript:void(0)" onclick="firozabad_Material_cat('material','CC'); updateNavBarWithFunctionName('Road Material CC');" style="color:#1ad7b0;">${safeValue('count_cc')}</a><br>
                Interlocking - <a href="javascript:void(0)" onclick="firozabad_Material_cat('material','Interlocking'); updateNavBarWithFunctionName('Road Material Interlocking');" style="color:#2392ed;">${safeValue('count_interlocking')}</a><br>
                BOE - <a href="javascript:void(0)" onclick="firozabad_Material_cat('material','BOE'); updateNavBarWithFunctionName('Road Material BOE');" style="color:#f228ab;">${safeValue('count_boe')}</a><br>
                Kachcha - <a href="javascript:void(0)" onclick="firozabad_Material_cat('material','Kachcha'); updateNavBarWithFunctionName('Road Material Kachcha');" style="color:#6036d0;">${safeValue('count_kachcha')}</a><br>
                NA - <a href="javascript:void(0)" onclick="firozabad_Material_cat('material','NA'); updateNavBarWithFunctionName('Road Material NA');" style="color:#dfc223;">${safeValue('count_na')}</a>
                `,
            onclick: 'firozabad_Material()'
        },
        'Road Count by Ownership': {
            value: ` 
                FNN - <a href="javascript:void(0)" onclick="firozabad_Ownership_cat('ownership','FNN'); updateNavBarWithFunctionName('Road Ownership firozabad Nagar Nigam');" style="color:#5aeee5;">${safeValue('count_fnn')}</a><br>
                PWD - <a href="javascript:void(0)" onclick="firozabad_Ownership_cat('ownership','PWD'); updateNavBarWithFunctionName('Road Ownership PWD');" style="color:#69e70f;">${safeValue('count_pwd')}</a><br>
                Private Road - <a href="javascript:void(0)" onclick="firozabad_Ownership_cat('ownership','Private Road'); updateNavBarWithFunctionName('Road Ownership Private Road');" style="color:#ed2323;">${safeValue('count_pvt')}</a><br>
                C M GRID - <a href="javascript:void(0)" onclick="firozabad_Ownership_cat('ownership','C.M GRID'); updateNavBarWithFunctionName('Road Ownership C M GRID ');" style="color:#f16a16;">${safeValue('count_grid')}</a><br>
                Others - <a href="javascript:void(0)" onclick="firozabad_Ownership_cat('ownership','Others'); updateNavBarWithFunctionName('Road Ownership Others');" style="color:#831042;">${safeValue('count_others')}</a>         
                `,
            onclick: 'firozabad_Ownership()'
        },
        'Road Count by CUS': {
            value: `
                14th Finance - <a href="javascript:void(0)" onclick="firozabad_CUS_cat('cus','14Th Finance'); updateNavBarWithFunctionName('Road CUS 14th Finance');" style="color:#ec1248;">${safeValue('count_cus_14th')}</a><br>
                15th Finance - <a href="javascript:void(0)" onclick="firozabad_CUS_cat('cus','15Th Finance'); updateNavBarWithFunctionName('Road CUS 15th Finance');" style="color:#e63dee;">${safeValue('count_cus_15th')}</a><br>
                Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="firozabad_CUS_cat('cus','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('Road CUS Nagar Nigam Nidhi');" style="color:cyan;">${safeValue('count_cus_nnn')}</a><br>
                NA - <a href="javascript:void(0)" onclick="firozabad_CUS_cat('cus','NA'); updateNavBarWithFunctionName('Road CUS NA');" style="color:#e1ca4c;">${safeValue('count_cus_na')}</a><br>
                PWD - <a href="javascript:void(0)" onclick="firozabad_CUS_cat('cus','PWD'); updateNavBarWithFunctionName('Road CUS PWD');" style="color:#e63dee;">${safeValue('count_cus_pwd')}</a><br>
                Others - <a href="javascript:void(0)" onclick="firozabad_CUS_cat('cus_class','Others'); updateNavBarWithFunctionName('Road CUS Others');" style="color:cyan;">${safeValue('count_cus_others')}</a><br>
                 `,
            // onclick: 'firozabad_CUS()'
        },
        'Road Count by Category': {
            value: `
                Local Street - <a href="javascript:void(0)" onclick="firozabad_Type_cat('category','Local Street'); updateNavBarWithFunctionName('Road Category Local Street');" style="color: #14cee3;">${safeValue('count_local')}</a><br>
                Collector - <a href="javascript:void(0)" onclick="firozabad_Type_cat('category','Collector'); updateNavBarWithFunctionName('Road Category Collector');" style="color: #e63dee;">${safeValue('count_collector')}</a><br>
                Arterial - <a href="javascript:void(0)" onclick="firozabad_Type_cat('category','Arterial'); updateNavBarWithFunctionName('Road Category Arterial');" style="color: #e1ca4c;">${safeValue('count_arterial')}</a><br>
                Sub Arterial - <a href="javascript:void(0)" onclick="firozabad_Type_cat('category','Sub Arterial'); updateNavBarWithFunctionName('Road Category Subarterial');" style="color: #83e45c;">${safeValue('count_subarterial')}</a><br>
                `,
            // onclick: 'firozabad_Category()'
...
function updateZones(zoneNo, zoneName, data) {
    ...
    //             value: `<a href="javascript:void(0)" onclick="firozabad_Zone_no('zone_no','${zoneNo}'); updateNavBarWithFunctionName('Zone-${zoneNo} Total Road Length');" style="color:black;">${data.length_km.toFixed(2)} km</a>`
    //         },
    //         {
    //             title: 'Total No. of Roads',
    //             value: `<a href="javascript:void(0)" onclick="firozabad_Zone_no('zone_no','${zoneNo}'); updateNavBarWithFunctionName('Zone-${zoneNo} Total Road Count');" style="color:black;">${data.total_no_of_roads}</a>`
    //         },
    //         // { 
    //         //     title: 'Road Type', 
    //         //     value: `Major <a href="javascript:void(0)" onclick="firozabad_Zone_Type('${zoneNo}','type','Major City Road'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Type Major');" style="color:blue;">- ${data.total_major_sum}</a> <br> 
    //         //             Minor <a href="javascript:void(0)" onclick="firozabad_Zone_Type('${zoneNo}','type','Minor City Road'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Type Minor');" style="color:yellow;">- ${data.total_minor_sum}</a>`
    //         // },
    //         {
    //             title: 'Road Condition',
    //             value: `
    //                     Good <a href="javascript:void(0)" onclick="firozabad_Zone_Condition('${zoneNo}','condition','Good'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition Good');" style="color:green;">- ${data.count_green}</a> <br> 
    //                     Moderate <a href="javascript:void(0)" onclick="firozabad_Zone_Condition('${zoneNo}','condition','Moderate'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition Moderate');" style="color:yellow;">- ${data.count_yellow}</a> <br> 
    //                     Poor <a href="javascript:void(0)" onclick="firozabad_Zone_Condition('${zoneNo}','condition','Poor'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition Poor');" style="color:red;">- ${data.count_red}</a><br>
    //                     NA <a href="javascript:void(0)" onclick="firozabad_Zone_Condition('${zoneNo}','condition','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Condition NA');" style="color:pink;">- ${data.count_na}</a> <br> 
    //                     `
    //         },
    //         {
    //             title: 'Materials',
    //             value: `
    //                     Bitumen <a href="javascript:void(0)" onclick="firozabad_Zone_Material('${zoneNo}','material','Bitumen'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material Bitumen');" style="color:darkred;">- ${data.bitumen}</a> <br>
    //                     CC <a href="javascript:void(0)" onclick="firozabad_Zone_Material('${zoneNo}','material','CC'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material CC');" style="color:#1ad7b0;">- ${data.cc}</a> <br>
    //                     Interlocking <a href="javascript:void(0)" onclick="firozabad_Zone_Material('${zoneNo}','material','Interlocking'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material Interlocking');" style="color:#2392ed;">- ${data.interlocking}</a> <br>
    //                     BOE <a href="javascript:void(0)" onclick="firozabad_Zone_Material('${zoneNo}','material','BOE'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material BOE');" style="color:#f228ab;">- ${data.boe}</a> <br>
    //                     Kachcha <a href="javascript:void(0)" onclick="firozabad_Zone_Material('${zoneNo}','material','Kachcha'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material Kachcha');" style="color:#6036d0;">- ${data.kachcha}</a><br>
    //                     NA - <a href="javascript:void(0)" onclick="firozabad_Zone_Material('${zoneNo}','material','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Material NA');" style="color:#dfc223;">${data.count_na}</a>
    //                     `
    //         },
    //         {
    //             title: 'Ownership',
    //             value: `
    //                 ALGNN - <a href="javascript:void(0)" onclick="firozabad_Zone_Ownership('${zoneNo}','ownership','Nagar Nigam'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership firozabad Nagar Nigam');" style="color:#5aeee5;">${data.count_algnn}</a><br>
    //                 PWD - <a href="javascript:void(0)" onclick="firozabad_Zone_Ownership('${zoneNo}','ownership','PWD'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership PWD');" style="color:#69e70f;">${data.count_pwd}</a><br>
    //                 Deparment Roads - <a href="javascript:void(0)" onclick="firozabad_Zone_Ownership('${zoneNo}','ownership','Department Roads'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Deparment Roads');" style="color:#f16a16;">${data.count_department_roads}</a><br>
    //                 Private Roads - <a href="javascript:void(0)" onclick="firozabad_Zone_Ownership('${zoneNo}','ownership','Private'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Private Road');" style="color:#ed2323;">${data.count_pvt}</a><br>
    //                 Institutional Roads - <a href="javascript:void(0)" onclick="firozabad_Zone_Ownership('${zoneNo}','ownership','Institutional Roads'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Institutional Roads');" style="color:#5aeee5;">${data.count_institutional_roads}</a><br>
    //                 NHAI - <a href="javascript:void(0)" onclick="firozabad_Zone_Ownership('${zoneNo}','ownership','NHAI'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership NHAI');" style="color:#69e70f;">${data.count_nhai}</a><br>
    //                 C.M GRID - <a href="javascript:void(0)" onclick="firozabad_Zone_Ownership('${zoneNo}','ownership','C.M GRID'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership C.M GRID');" style="color:#f16a16;">${data.count_grid}</a><br>
    //                 Railway - <a href="javascript:void(0)" onclick="firozabad_Zone_Ownership('${zoneNo}','ownership','Railway'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Ownership Railway');" style="color:#ed2323;">${data.count_railway}</a><br> 
    ...
    //             title: 'CUS',
    //             value: ` 
    //                 Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="firozabad_Zone_CUS('${zoneNo}','cus','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Nagar Nigam Nidhi');" style="color: cyan;">${data.count_cus_nnn}</a><br>
    //                 PWD - <a href="javascript:void(0)" onclick="firozabad_Zone_CUS('${zoneNo}','cus','P.W.D'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS PWD');" style="color: #173dd6;">${data.count_cus_pwd}</a><br>
    //                 SFC - <a href="javascript:void(0)" onclick="firozabad_Zone_CUS('${zoneNo}','cus','SFC'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS SFC');" style="color: #14ea54;">${data.count_cus_sfc}</a><br>
    //                 Vidhayak Nidhi - <a href="javascript:void(0)" onclick="firozabad_Zone_CUS('${zoneNo}','cus','Vidhayak Nidhi'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS Vidhayak Nidhi');" style="color: #6e52e7;">${data.count_cus_vidhayak}</a><br>
    //                 RES - <a href="javascript:void(0)" onclick="firozabad_Zone_CUS('${zoneNo}','cus','RES'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS RES');" style="color: #e6497d;">${data.count_cus_res}</a><br>
    //                 UPSLDA - <a href="javascript:void(0)" onclick="firozabad_Zone_CUS('${zoneNo}','cus','UPSLDA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS UPSLDA');" style="color: #f4ee40;">${data.count_cus_upslda}</a><br>
    //                 Jila PANCHAYAT - <a href="javascript:void(0)" onclick="firozabad_Zone_CUS('${zoneNo}','cus','Jila Panchayat'); updateNavBarWithFunctionName('Road CUS Jila Panchayat');" style="color: #bad057;">${data.count_cus_jila_panchayat}</a><br>
    //                 NHAI- <a href="javascript:void(0)" onclick="firozabad_Zone_CUS('${zoneNo}','cus','NHAI'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS NHAI');" style="color: #bad057;">${data.count_cus_nhai}</a><br>
    //                 NA - <a href="javascript:void(0)" onclick="firozabad_Zone_CUS('${zoneNo}','cus','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road CUS NA');" style="color: #8717e2;">${data.count_cus_na}</a><br>
    //                 `
    //         },
    //         {
    //             title: 'Type Sub Category',
    //             value: `
    //                     Local Street - <a href="javascript:void(0)" onclick="firozabad_Zone_TypeSub('${zoneNo}','category','Local Street'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category Local Street');" style="color: #14cee3;">${data.count_local_street} </a><br>
    //                     Collector - <a href="javascript:void(0)" onclick="firozabad_Zone_TypeSub('${zoneNo}','category','Collector'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category Collector');" style="color: #e63dee;">${data.count_collector}</a><br>
    //                     Arterial - <a href="javascript:void(0)" onclick="firozabad_Zone_TypeSub('${zoneNo}','category','Arterial'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category Arterial');" style="color: #e1ca4c;">${data.count_arterial}</a><br>
    //                     Sub Arterial - <a href="javascript:void(0)" onclick="firozabad_Zone_TypeSub('${zoneNo}','category','Sub Arterial'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category Sub Arterial');" style="color: #83e45c;">${data.count_subarterial}</a><br>
    //                     NA - <a href="javascript:void(0)" onclick="firozabad_Zone_TypeSub('${zoneNo}','category','NA'); updateNavBarWithFunctionName('Zone-${zoneNo} Road Category NA');" style="color: #83e45c;">${data.count_na}</a><br>
    //                    `
        ...
        .then(responseData => {
            if (responseData.status) {
                ...
                const details = [
                    // { 
                    //     title: 'Road Type', 
                    //     value: `Major - <a href="javascript:void(0)" onclick="firozabad_Ward_Type('${wardNo}', 'type', 'Major City Road'); updateNavBarWithFunctionName('Ward-${wardNo} Road Type Major');" style="color:blue;">${responseData.total_major_sum}</a><br> 
                    //              Minor - <a href="javascript:void(0)" onclick="firozabad_Ward_Type('${wardNo}', 'type', 'Minor City Road'); updateNavBarWithFunctionName('Ward-${wardNo} Road Type Minor');" style="color:orange;">${responseData.total_minor_sum}</a>` 
                    // },
                    {
                        title: 'Total Road Length',
                        value: `<a href="javascript:void(0)" onclick="firozabad_Ward_no('ward_no', '${wardNo}'); updateNavBarWithFunctionName('${wardNo} Total Road Length');" style="color:black;">${responseData.length_km} km</a>`
                    },
                    {
                        title: 'Total No. of Roads',
                        value: `<a href="javascript:void(0)" onclick="firozabad_Ward_no('ward_no', '${wardNo}'); updateNavBarWithFunctionName('${wardNo} Total Road Count');" style="color:black;">${responseData.total_no_of_roads}</a>`
                    },
                    {
                        title: 'Road Condition',
                        value: `
                                Good - <a href="javascript:void(0)" onclick="firozabad_Ward_Condition('${wardNo}', 'condition', 'Good'); updateNavBarWithFunctionName(' ${wardNo} Road Condition Good');" style="color:green;">${responseData.condition_count_green}</a><br> 
                                Moderate - <a href="javascript:void(0)" onclick="firozabad_Ward_Condition('${wardNo}', 'condition', 'Moderate'); updateNavBarWithFunctionName('${wardNo} Road Condition Moderate');" style="color:yellow;">${responseData.condition_count_yellow}</a><br> 
                                Poor - <a href="javascript:void(0)" onclick="firozabad_Ward_Condition('${wardNo}', 'condition', 'Poor'); updateNavBarWithFunctionName('${wardNo} Road Condition Poor');" style="color:red;">${responseData.condition_count_red}</a><br>
                                NA - <a href="javascript:void(0)" onclick="firozabad_Ward_Condition('${wardNo}', 'condition', 'NA'); updateNavBarWithFunctionName('${wardNo} Road Condition NA');" style="color:pink;">${responseData.condition_count_na}</a>
                                `
                    },
                    {
                        title: 'Materials',
                        value: `
                                Bitumen - <a href="javascript:void(0)" onclick="firozabad_Ward_Material('${wardNo}', 'material', 'Bitumen'); updateNavBarWithFunctionName('${wardNo} Road Material Bitumen');" style="color:darkred;">${responseData.count_bitumen}</a><br> 
                                CC - <a href="javascript:void(0)" onclick="firozabad_Ward_Material('${wardNo}', 'material', 'CC'); updateNavBarWithFunctionName('${wardNo} Road Material CC');" style="color:cyan;">${responseData.count_cc}</a><br> 
                                Interlocking - <a href="javascript:void(0)" onclick="firozabad_Ward_Material('${wardNo}', 'material', 'Interlocking'); updateNavBarWithFunctionName('${wardNo} Road Material Interlocking');" style="color:blue;">${responseData.count_interlocking}</a><br>
                                BOE - <a href="javascript:void(0)" onclick="firozabad_Ward_Material('${wardNo}', 'material', 'BOE'); updateNavBarWithFunctionName('${wardNo} Road Material BOE');" style="color:pink;">${responseData.count_boe}</a><br> 
                                Kachcha - <a href="javascript:void(0)" onclick="firozabad_Ward_Material('${wardNo}', 'material', 'Kachcha'); updateNavBarWithFunctionName('${wardNo} Road Material Kachcha');" style="color:purple;">${responseData.count_kachcha}</a><br>
                                NA - <a href="javascript:void(0)" onclick="firozabad_Ward_Material('${wardNo}','material','NA'); updateNavBarWithFunctionName('${wardNo} Road Material NA');" style="color:#dfc223;">${responseData.count_na}</a>
                                `
                    },
                    {
                        title: 'Ownership',
                        value: `                              
                          FNN - <a href="javascript:void(0)" onclick="firozabad_Ward_Ownership('${wardNo}','ownership','FNN'); updateNavBarWithFunctionName('${wardNo} Road Ownership firozabad Nagar Nigam');" style="color:#5aeee5;">${responseData.count_fnn}</a><br>
                PWD - <a href="javascript:void(0)" onclick="firozabad_Ward_Ownership('${wardNo}','ownership','PWD'); updateNavBarWithFunctionName('${wardNo} Road Ownership PWD');" style="color:#69e70f;">${responseData.count_pwd}</a><br>
                Private Road - <a href="javascript:void(0)" onclick="firozabad_Ward_Ownership('${wardNo}','ownership','Private Road'); updateNavBarWithFunctionName('${wardNo} Road Ownership Private Road');" style="color:#ed2323;">${responseData.count_pvt}</a><br>
                C M GRID - <a href="javascript:void(0)" onclick="firozabad_Ward_Ownership('${wardNo}','ownership','C.M GRID'); updateNavBarWithFunctionName('${wardNo} Road Ownership C M GRID ');" style="color:#f16a16;">${responseData.count_grid}</a><br>
                Others - <a href="javascript:void(0)" onclick="firozabad_Ward_Ownership('${wardNo}','ownership','Others'); updateNavBarWithFunctionName('${wardNo} Road Ownership Others');" style="color:#831042;">${responseData.count_others}</a>         
               `
                    },
                    {
                        title: 'CUS',
                        value: `
                            14th Finance - <a href="javascript:void(0)" onclick="firozabad_Ward_CUS('${wardNo}','cus','14Th Finance'); updateNavBarWithFunctionName('${wardNo}Road CUS 14th Finance');" style="color:#ec1248;">${responseData.count_cus_14th}</a><br>
                15th Finance - <a href="javascript:void(0)" onclick="firozabad_Ward_CUS('${wardNo}',cus','15Th Finance'); updateNavBarWithFunctionName('${wardNo} Road CUS 15th Finance');" style="color:#e63dee;">${responseData.count_cus_15th}</a><br>
                Nagar Nigam Nidhi - <a href="javascript:void(0)" onclick="firozabad_Ward_CUS('${wardNo}','cus','Nagar Nigam Nidhi'); updateNavBarWithFunctionName('${wardNo} Road CUS Nagar Nigam Nidhi');" style="color:cyan;">${responseData.count_cus_nnn}</a><br>
                NA - <a href="javascript:void(0)" onclick="firozabad_Ward_CUS('${wardNo}','cus','NA'); updateNavBarWithFunctionName('${wardNo} Road CUS NA');" style="color:#e1ca4c;">${responseData.count_cus_na}</a><br>
                PWD - <a href="javascript:void(0)" onclick="firozabad_Ward_CUS('${wardNo}','cus','PWD'); updateNavBarWithFunctionName('${wardNo} Road CUS PWD');" style="color:#e63dee;">${responseData.count_cus_pwd}</a><br>
                Others - <a href="javascript:void(0)" onclick="firozabad_Ward_CUS('${wardNo}','cus_class','Others'); updateNavBarWithFunctionName('${wardNo} Road CUS Others');" style="color:cyan;">${responseData.count_cus_others}</a><br>
                `  },
                    {
                        title: 'Type Sub Category',
                        value: `
                                Local Street - <a href="javascript:void(0)" onclick="firozabad_Ward_TypeSub('${wardNo}','category','Local Street'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category Local Street');" style="color: #14cee3;">${responseData.count_local_street} </a><br>
                                Collector - <a href="javascript:void(0)" onclick="firozabad_Ward_TypeSub('${wardNo}','category','Collector'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category Collector');" style="color: #e63dee;">${responseData.count_collector}</a><br>
                                Arterial - <a href="javascript:void(0)" onclick="firozabad_Ward_TypeSub('${wardNo}','category','Arterial'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category Arterial');" style="color: #e1ca4c;">${responseData.count_arterial}</a><br>
                                Sub Arterial - <a href="javascript:void(0)" onclick="firozabad_Ward_TypeSub('${wardNo}','category','Sub Arterial'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category Sub Arterial');" style="color: #83e45c;">${responseData.count_subarterial}</a><br>
                                NA - <a href="javascript:void(0)" onclick="firozabad_Ward_TypeSub('${wardNo}','category','NA'); updateNavBarWithFunctionName('Ward-${wardNo} Road Category NA');" style="color: #83e45c;">${responseData.count_na}</a><br>
                              `},
                ];
...
function highlightFeatureOnMap(gisId) {
    let wfsUrl = `${GEOSERVER_BASE_URL}/wfs?service=WFS&version=1.1.0&request=GetFeature
        &typename=FRZ_Summary:firozabad_road_net
        &outputFormat=application/json
...
function firozabad_road_Length_Count() {
    removeCurrentLayer();
    clearVectorLayers();
    ...
    currentLayer = new ol.layer.Image({
        ...
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_net',
...
function firozabad_Ownership(cqlFilter) {
    removeCurrentLayer(); clearVectorLayers();
    currentLayer = new ol.layer.Image({
        //   title: 'Ward Boundary',
        //     extent: [-180, -90, -180, 90],
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_own',
...
function firozabad_Material(cqlFilter) {
    removeCurrentLayer(); clearVectorLayers();
    currentLayer = new ol.layer.Image({
        //   title: 'Ward Boundary',
        //     extent: [-180, -90, -180, 90],
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_material',
                'CQL_FILTER': cqlFilter,
            },
            ratio: 1,
            serverType: 'geoserver'
...
function firozabad_Types(cqlFilter) {
    removeCurrentLayer(); clearVectorLayers();
    currentLayer = new ol.layer.Image({
        //   title: 'Ward Boundary',
        //     extent: [-180, -90, -180, 90],
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_category',
                'CQL_FILTER': cqlFilter,
            },
            ratio: 1,
            serverType: 'geoserver'
...
$(document).ready(function () {
    ...
    var wfsParams = {
        ...
        typeName: 'FRZ_Summary:firozabad_road_net',   // Replace with your WFS layer typename
    ...
    const url = `${GEOSERVER_BASE_URL}/wfs?service=WFS&version=1.0.0&request=GetFeature&typeName=FRZ_Summary:firozabad_road_net&outputFormat=application/json`;
...
function firozabad_Zone_no(column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
...
function firozabad_Ward_no(column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
...
function firozabad_Condition_cat(column, value) {
    removeCurrentLayer();
    ///  clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_condition',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function firozabad_Material_cat(column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_material',  // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function firozabad_Ownership_cat(column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_own',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function firozabad_CUS_cat(column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_cus',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function firozabad_Type_cat(column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
    // Define dynamic CQL filter
    let cqlFilter = `(${column}='${value}' OR ${column} ILIKE '%/${value}' OR ${column} ILIKE '${value}/%' OR ${column} ILIKE '%/${value}/%' OR ${column} ILIKE '${value}')`;
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_category',   // Same layer for all filters
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function firozabad_Zone_Condition(zone_no, column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_condition',
                'CQL_FILTER': cqlFilter,
                'TILED': true
            },
            ratio: 1,
...
function firozabad_Zone_Material(zone_no, column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_material',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function firozabad_Zone_Ownership(zone_no, column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus"];
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_own',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function firozabad_Zone_CUS(zone_no, column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus"];
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_cus',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function firozabad_Zone_TypeSub(zone_no, column, value) {
    removeCurrentLayer();
    clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus",];
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_category',   // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function firozabad_Ward_Condition(ward_no, column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
    ...
    currentLayer = new ol.layer.Image({
        source: new ol.source.ImageWMS({
            url: `${GEOSERVER_BASE_URL}/wms`,
            params: {
                'LAYERS': 'FRZ_Summary:firozabad_road_condition', // Main layer for filtering
                'CQL_FILTER': cqlFilter, // Apply dynamic filtering
                'TILED': true
            },
            ratio: 1,
...
function firozabad_Ward_Material(ward_no, column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus"];
...
function firozabad_Ward_Ownership(ward_no, column, value) {
    removeCurrentLayer();
    //  clearVectorLayers();
...
function firozabad_Ward_CUS(ward_no, column, value) {
    removeCurrentLayer();
    // clearVectorLayers();
...
function firozabad_Ward_TypeSub(ward_no, column, value) {
    removeCurrentLayer();
    clearVectorLayers();
    // Ensure column is valid to prevent errors
    let validColumns = ["condition", "category", "material", "ownership", "cus"];
...
function determineLayer() {
    if (selectedFilters.material) {
        return 'FRZ_Summary:firozabad_road_material';
    } else if (selectedFilters.type) {
        return 'FRZ_Summary:firozabad_road_category';
    } else if (selectedFilters.ownership) {
        return 'FRZ_Summary:firozabad_road_own';
    }
    return 'FRZ_Summary:firozabad_road_category';
}
